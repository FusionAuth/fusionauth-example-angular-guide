...
## Installation
* `git clone https://github.com/FusionAuth/fusionauth-example-angular-guide`
* `cd fusionauth-example-angular-guide`
...
* [Open a browser](http://localhost:4200) and log in using our user's credentials ("richard@example.com"/"password").
...
You can work through a tutorial here: https://fusionauth.io/docs/v1/tech/tutorials/integrate-angular
